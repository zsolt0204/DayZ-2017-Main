// config.bin - 09:55:00 11/09/12, generated in 0.09 seconds
...
class CfgMagazines {
	...
	class FoodCanDogFood : FoodEdible {
		scope = public;
		displayName = $STR_EQUIP_NAME_29;
		model = "\dayz_equip\models\food_pastatin.p3d";
		picture = "\dayz_equip\textures\equip_animl_ca.paa";
...
class CfgVehicles {
	...
	class FoodBox0 : CardboardBox {
		...
		class transportmagazines {
			...
			class _xx_FoodCanDogFood {
				magazine = "FoodCanDogFood";
				count = 6;
			};
		};
	};
