...
//Both
	...
	local_gutHuman =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\local_gutHuman.sqf";		//Generated on the server (or local to unit) when gutting an object
	local_gutZed =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\local_gutZed.sqf";		//Generated on the server (or local to unit) when gutting an object
