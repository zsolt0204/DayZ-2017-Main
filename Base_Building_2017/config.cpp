class CfgPatches
{
 ...
 {
  units[] = {"Garbage_container_DZ","Land_Misc_Scaffolding_DZ","UralWreck_DZ","datsun02Wreck_DZ","Land_KBud_DZ","Fort_Barricade_EP1_DZ","Land_fort_artillery_nest_DZ","Land_HBarrier1_DZ","Land_Shed_M03_DZ","vehicleShelter_us_DZ","Hhedgehog_concrete_DZ","Land_prebehlavka_DZ","Fence_corrugated_plate_DZ","Land_CncBlock_DZ","ZavoraAnim_DZ","Fort_RazorWire_DZ","Fence_Ind_DZ","Fence_Ind_long_DZ","UAZWreck_DZ","Land_prolejzacka_DZ","Fort_Barricade_DZ","Land_kulna_DZ","Land_tent_east_DZ","Land_Misc_deerstand_DZ"};
  weapons[] = {};
  requiredVersion = 0.1;
